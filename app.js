...
function multiplyArray(multArr) { //eslint-disable-line
  ...
  var message = "The numbers "+ testArray[0]+ "," + testArray[1]+ "," + testArray[2]+ " have a product of " + multiply2 + "."
...
function multiplyAnyArray(dynamicArray) { 
  //eslint-disable-line
  var multiply1 = multiply(testDynamicArray[0],testDynamicArray[1])[0];
  var multiply2 = multiply(multiply1, testDynamicArray[2])[0];
  var multiply3 = multiply(multiply2,testDynamicArray[3])[0];
  var multiply4 = multiply(multiply3, testDynamicArray[4])[0];
  var message = "The numbers "+ testDynamicArray[0]+ "," + testDynamicArray[1]+ "," + testDynamicArray[2] + "," + testDynamicArray[3] + "," + testDynamicArray[4]+ " have a product of " + multiply4 + "."
  return[multiply4, message]
